        ...
        <div className="featured-case">
          <div className="case-hero">
            ...
            <div className="case-hero-overlay">
              ...
              <div className="case-meta">
                <span>Ì≥Ö Duration: {currentCase.duration}</span>
                <span>Ìø¢ Client: {currentCase.clientName}</span>
              </div>
            </div>
          </div>
          ...
          <div className="case-content">
            ...
            <div className="case-actions">
              <a href="/contact" className="btn-primary">Discuss Similar Project ‚Üí</a>
            ...
            {caseStudiesData.map((caseStudy, index) => (
              ...
              >
                ...
                <div className="case-card-content">
                  ...
                  <button className="read-more-btn">Read Case Study ‚Üí</button>
                </div>
              </div>
            ))}
          </div>
