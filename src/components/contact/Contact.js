          ...
          <div className="contact-form-card">
            ...
            {submitted && (
              <div className="success-alert">
                ✓ {applicationDetected ? 'Your job application has been sent successfully! Our HR team will review your application and contact you within 3-5 business days.' : 'Message sent successfully! Our team will contact you soon.'}
              </div>
            )}
                ...
                <div className="team-card-inner">
                  ...
                  <div className="team-info">
                    ...
                    <div className="team-social-links">
                      ...
                      <a href={owner.social.twitter} target="_blank" rel="noopener noreferrer" className="social-link twitter">𝕏</a>
                      <a href={`https://wa.me/${owner.whatsapp}`} target="_blank" rel="noopener noreferrer" className="social-link whatsapp">💬</a>
                    </div>
                  </div>
                </div>
              </div>
